...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess, currentTheme }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 login-gradient-bg z-0"></div>
      <div className="w-full max-w-md space-y-8 bg-gray-100/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-2xl rounded-lg p-8 z-10">
